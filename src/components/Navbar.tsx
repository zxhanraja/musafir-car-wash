    ...
    <>
      <nav
        className={cn(
          ...
          mobileMenuOpen && "bg-[#050505] backdrop-blur-none border-transparent py-4" // Ensure solid background and consistent padding when open
        )}
      >
        <div className="w-full max-w-[1440px] mx-auto px-6 lg:px-12 flex items-center justify-between pointer-events-auto">
          ...
          {/* Mobile Menu Toggle */}
          <button
            className="lg:hidden relative z-50 p-2 text-brand-white hover:text-brand-red transition-colors pointer-events-auto"
